 ...
 * Plugin URI: https://github.com/hchouhan/Portfolio-by-Themeist
 * Description: Portfolio Custom Post Type for WordPress.  This plugin allows you to manage, edit, and create new portfolio items in an unlimited number of portfolios.
 * Version: 0.1.0
 * Author: Harish Chouhan
 * Author URI: http://harishchouhan.com
 *
 ...
 *
 * @package WordPress
 * @subpackage Themeist_Portfolio
 * @version   0.1.0
 * @since     0.1.0
 * @author    Harish Chouhan <hello@dreamsmedia.in>
 * @copyright Copyright (c) 2014, Harish Chouhan
